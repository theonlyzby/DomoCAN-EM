...
(function($) {
    ...
    $.fn.getWeather = function(el) {
        ...
        el.find('#weather').html('<p class="loading">Mise à jour ...</p>');
        el.find('#forecast_container').html('<p class="loading">Mise à jour ...</p>');
        ...
        $.getJSON('lib/meteo/proxy/' + proxy + '?location=' + el.weatherLocationCode + '&metric=' + el.weatherMetric, function(data) {
            ...
            curr_for    += '<p class="text" style="display: none;">' + data.forecast[0].day_text + '</p>';
